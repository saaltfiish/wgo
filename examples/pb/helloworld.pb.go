...
func (_ _GreeterService) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, nil
}
...
func RegisterGreeterServer1(s *grpc.Server) {
	s.RegisterService(&_Greeter_serviceDesc, _GreeterService{})
}
